<template>
    <section id="home">
       <header class="home-header">
        ...
        <h1>최고의 순간,당신을 <span>초대</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 합니다.</h1>
       </header>
       <svg class="home-logo" version="1.1" id="레이어_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 200" style="enable-background:new 0 0 200 200;" xml:space="preserve">
<g>
	<g>
		<g>
	...
	<g>
        ...
        <h2 class="home-description">결혼, 돌잔치, 생일, 각종 행사 모바일 초대장 서비스</h2>
        <div class="custom-shape-divider-bottom-1654822575">
...
<style lang="scss">
    ...
    #home{
        ...
        .home-header{
            ...
            height: 450px;
            // background
            background: url(../../../public/images/wedding/wedding-bg.jpg)no-repeat center/cover;
            // filter
            ...
            h1{
                ...
                span{
                    ...
                    // animation 
                    animation-name: spanBounceAnimation;
        ...
        margin: 0 auto;
        // svg st
        .st0{fill:var(--sub-color);}
        .st1{fill:none;stroke:var(--sub-color);stroke-width:3;stroke-linecap:round;stroke-miterlimit:10;}
        }
        .home-description{
            // font
            font-family: var(--font-kr);
